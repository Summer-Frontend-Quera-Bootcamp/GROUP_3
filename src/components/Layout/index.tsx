  ...
  return (
    <div className="w-full h-screen fixed m-auto ">
      <header className="w-[1700px] h-[51px] fixed top-[80px] left-[80px] flex justify-between">
        <h1 className="w-[223px] h-[51px] font-iran-yekan font-bold text-[32px] leading-[37.5px] m-0 text-right bg-gradient-to-r from-[#118c80] to-[#4ab7d8]  bg-clip-text [-webkit-text-fill-color:transparent] justify-center items-center">
          کوئرا تسک منیجر
        </h1>
